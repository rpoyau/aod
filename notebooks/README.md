...
- Main note = compact theorem line (`notebooks/`)
...
- Supplement C = grouped regime notebooks (`supplement-c/notebooks/solar/`, `hydrogen/`, `nucleus/`, `galactic/`, `bacteria/`, `saturn/`)
...
| Loss / B* / collision | `supplement-a/notebooks/E4-E6.ipynb` | Supplement A | loss-channel, B* ladder, collision/export diagrams |
