...
\toprule
Row & $T_{\mathrm{eval}}$ [bip] & $N_m=(n_1,n_2,n_3)$ & $B^*$ & $\Lambda_b$ & $R_{\mathrm{rest}}$ [trit/bip] & $R_{\mathrm{rest}}^{(\mathrm{biz})}$ [biz] \\
\midrule
...
$B^*$ / $\Lambda_b$ & $137 / 6$ \\
$R_{\mathrm{rest}}$ & $(1+8\ell_2)/24$ [trit/bip] \\
$R_{\mathrm{rest}}^{(\mathrm{biz})}$ & $\bigl(3^{(1+8\ell_2)/24}-1\bigr)137^{-6}$ [biz] \\
$q_{\mathrm{eff}}$ & $+1/2$ \\
$T_{\mathrm{tors}}$ & $3$ \\
\bottomrule
\end{tabular}
...
\toprule
Row & $q_{\mathrm{eff}}$ & $\widehat q_{\mathrm{eff}}$ & $\eta_{\mathrm{out}}$ & $\eta_{\mathrm{mid}}$ & $\eta_{\mathrm{tot}}$ & $f_0$ & $B^*$ & $R_{\mathrm{rest}}$ [trit/bip] & $n_{\mathrm{ref}}$ \\
\midrule
...
\end{tabular}
\end{center}}
\paragraph{Symbol key.} Here $\widehat q_{\mathrm{eff}}$ is the normalized effective-charge proxy, $\eta_{\mathrm{out}}$, $\eta_{\mathrm{mid}}$, and $\eta_{\mathrm{tot}}$ are the cited coupling-partition ratios on the same ledger, $f_0$ is the dwell fraction, and $n_{\mathrm{ref}}$ is the delay witness on the cited row.
