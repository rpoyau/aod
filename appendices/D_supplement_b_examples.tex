...
\paragraph{Native rest-channel convention.} The primitive rest-facing channel is reported here as $R_{\mathrm{rest}}$ [trit/put], with the same values as the native loss channel on the cited row.
\paragraph{Native row(s).}
{\footnotesize
\begin{center}
\begin{tabular}{@{}llllllll@{}}
\toprule
Row & topology & $R_{\mathrm{rest}}$ [trit/put] & $B^*$ & $\widehat\Lambda$ & $R_{\mathrm{rest}}^{(\mathrm{putz})}$ & CK mismatch & $\mathcal R_{\mathrm{cut}}$ \\
\midrule
