...
\midrule
E4 native rest-channel row & bip-to-seconds, Hz, J, kg, MeV/$c^2$ dictionaries & downstream dictionary rendering \\
...
\end{tabular}
\end{center}}
\paragraph{Native anchor.} These decimals are convenience renderings of the cited native E11 ledger and must not be used as operator premises. Here $R_{\mathrm{rest}}$ is the primitive rest-facing channel on the cited row, carrying the same value as the native loss channel on that row.
