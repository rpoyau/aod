...
\paragraph{Confinement and isotope labels.} Confinement names the short-window persistence class defined on the cited tetron/tetrad ledgers. Isotope labels, when reported later, name stability subclasses on those same cited ledgers.
