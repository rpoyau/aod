...
A local transition state on an oriented edge carries the ternary fibre
\[
\sigma_t(e)\in\{-1,0,+1\},
\]
...
\aodremark{The \(Q_4\) chart is a finite Hamming--1 graph. The kernel supplies admissible transition histories; it does not replace the scoped flux calculation.}
