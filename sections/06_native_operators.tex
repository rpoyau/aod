...
\begin{remarkx}
This is the Stokes-style witness for unresolved torsional imbalance on the cited readout family.
\end{remarkx}
...
For a declared shell band or active-cut family, the cadence extractor returns completed-cycle counts $N_{\rho,k}^{\mathrm{cyc}}(\omega)$ together with the shell-signature class, shell-resolved completion periods $P_{\rho,k}(\omega)$, shell-resolved phase indices $\rho_k(\omega)$, cycle-ratio phases
\[
