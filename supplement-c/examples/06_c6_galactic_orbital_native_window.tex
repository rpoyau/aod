...
\paragraph{Temporal conversion block.} The converted witness below is attached after the cited native row.

 Temporal conversion is a normal chain-rule expansion on the cited native row. The converted witness table records calculated outer-orbital speed, the cited SPARC reference speed, absolute error, and relative error for the five extracted galaxy slices.
