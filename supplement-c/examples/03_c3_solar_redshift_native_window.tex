\subsection{C3 -- Solar redshift as a two-window duon cadence-transfer test}\label{suppc:c3-solar-redshift}
...
\paragraph{Temporal conversion block.} The cited source/receiver row is fixed first. The familiar solar redshift is then attached afterward as a rounded rendering.

\textit{Rendered witness.} The converted witness below records the rendered source/receiver comparison.
