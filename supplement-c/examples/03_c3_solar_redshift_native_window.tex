...
\paragraph{Converted comparison witness.} Temporal conversion is a normal chain-rule expansion on the cited native row. The rendered solar redshift witness is reported against the cited benchmark by the following comparison row.

\begin{center}
\footnotesize
\begin{tabularx}{\linewidth}{@{}lccccX@{}}
\toprule
Subledger & Calculated & Reference & Abs. error & Rel. error [\%] & Note \\n\midrule
$[\omega_{\mathrm{src}},\omega_{\mathrm{rcv}}]$ & $2.122566754396204\times 10^{-6}$ & $2.12\times 10^{-6}$ & $+2.5667543962039824\times 10^{-9}$ & +0.12107332057565955 & Solar redshift witness on the cited source/receiver ledger \\n\bottomrule
\end{tabularx}
\end{center}
