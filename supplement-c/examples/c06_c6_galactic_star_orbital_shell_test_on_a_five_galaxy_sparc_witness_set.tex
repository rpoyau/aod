...
\paragraph{Rendered witness set.}
\begin{center}
\footnotesize
\begin{tabularx}{\linewidth}{@{}lXc c X@{}}
\toprule
Galaxy & Slice key & Plateau type & $v^{\mathrm{out}}_{\mathrm{orb}}$ [km/s] & Rendered note \\
\midrule
NGC\,2403 & \texttt{tetron:*:[NGC2403,star]:6} & rising-to-flat & 134.4 & compact spiral shell family \\
NGC\,3198 & \texttt{tetron:*:[NGC3198,star]:6} & flat & 149.2 & classic long outer-shell plateau \\
NGC\,6503 & \texttt{tetron:*:[NGC6503,star]:6} & flat & 115.6 & tight shell packing \\
NGC\,2841 & \texttt{tetron:*:[NGC2841,star]:6} & flat & 288.2 & heavy outer-shell support \\
DDO\,154 & \texttt{tetron:*:[DDO154,star]:6} & slowly rising / flat tail & 47.0 & sparse outer-shell family \\
\bottomrule
\end{tabularx}
\end{center}
...
\paragraph{Temporal conversion block.} The slice family is fixed first. Familiar rendered comparison is then attached by quoting representative outer-orbital speed witnesses from the cited SPARC galaxies together with a Milky-Way-like plateau anchor. On the present rendering,
\[
...
\caption{Rendered outer-orbital speed witnesses for the cited SPARC galaxies, with a Milky-Way-like plateau anchor shown as a dashed comparison line. The purpose is to foreground orbital speeds directly, not only shell labels.}
\end{figure}
