#!/usr/bin/env python3
"""Generate the manual 3D Brownian coordinate-residue delta_3 presentation assets.

The fixture is integer-native: a track is mapped to Z^3, lagged displacements
...
def generate_figure():
    ...
    ax5.text(0.5, 0.08, "3D Brownian coordinate-residue delta_3 presentation: integer counts first; continuous summaries only after exact fixture", ha="center", fontsize=10, fontweight="bold")

    fig.suptitle(r"3D Brownian Coordinate-Residue $\delta_3$ Presentation", fontsize=16, fontweight="bold", y=0.985)
    fig.savefig(FIG_DIR / "brownian_phase_delta3_wireframe.png", bbox_inches="tight")
    plt.close(fig)
