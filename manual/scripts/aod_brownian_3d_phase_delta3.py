#!/usr/bin/env python3
"""Generate the manual 3D Brownian phase-cycle delta_3 fixture assets.
...
def generate_figure():
    ...
    ax5.text(0.5, 0.08, "3D Brownian Phase-Cycle delta_3 fixture: integer counts first; continuous summaries only after exact fixture", ha="center", fontsize=10, fontweight="bold")

    fig.suptitle(r"3D Brownian Phase-Cycle $\delta_3$ Fixture", fontsize=16, fontweight="bold", y=0.985)
