...
\section{Simulation and Prediction-Test Fixtures}
\label{manual:simulation-prediction-test-fixtures}

\subsection{Scope}
\label{manual:simfix:scope}
...
\label{manual:simfix:statements}
...
\subsection{Data-support class reference}
\label{manual:app:data-support-class-reference}
...
\subsection{Audit}
\label{manual:simfix:falsification}
