...
\caption{Galactic lensing diagnostic lanes.}\label{tab:manual-lensing-status-lock}\\
\toprule
...
\subsection{SPARC5 lens-medium diagnostic}\label{manual:lensing-sparc5-medium-diagnostic}
