...
This section records retained-shell forms for later planetary and ring-family examples. The rows here are manual-local scaffold rows with test support for source hygiene. Validated prediction rows require declared source maps, scripts, and tests.
...
\begin{table}[H]
\centering
\caption{Earth--Moon shell scaffold rows.}
\label{tab:earth-moon-shell-scaffold-rows}
...
The shared ring-family refinement shape is recorded for the Saturn shell row and the galactic outer-shell row. The refinement remains source-normalized or scaffolded until the corresponding application scripts and source maps are declared.
...
The raw setup, script, derived CSVs, figures, and tests are manual-local. They are listed in the manual artifact map and audited by the manual-local application-scaffold audit.
