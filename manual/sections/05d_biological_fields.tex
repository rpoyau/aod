...
\bottomrule
\end{tabularx}
\ManualTableNote{The cited bacteria window carries a mass-scaled loss/tension burden together with a cadence-noise band and a recurrent drift witness on one row.}
\end{threeparttable}
\end{table}
...
The cited bacteria row carries the recurrent-jitter and dwell-distribution witnesses on the same window.
