...
\section{Solar Observable-Map Fixtures}
\label{manual:solar-system-field-tests}
...
\subsection{Shared solar-system declaration}
\label{manual:solar:shared}
...
\subsection{SADAR observable bridge}
\label{manual:solar:observable-export-bridge}
...
\subsection{Observable-map comparison table}
\label{manual:solar:observable-map-table}
...
\toprule
Record & A\(\Omega\) value & Target & Residual & Abs. percent error\\
\midrule
Mercury perihelion & $42.9799$ arcsec/cy & $42.98$ arcsec/cy & $-0.0001$ arcsec/cy & $0.0002327\%$\\
Solar light bending & $1.75001$ arcsec & $1.75$ arcsec & $0.00001$ arcsec & $0.0005714\%$\\
Solar redshift & $2.11996\times10^{-6}$ & $2.12\times10^{-6}$ & $-4.0\times10^{-11}$ & $0.001887\%$\\
\bottomrule
\end{tabularx}
...
\subsection{Mercury perihelion window}
\label{manual:solar:mercury}
Declare
\[
...
\subsection{Solar light-bending boundary}
\label{manual:solar:light-bending}
Declare
\[
...
\subsection{Solar redshift transfer boundary}
\label{manual:solar:redshift}
Declare
\[
...
\label{manual:solar:audit-hooks}
\begin{itemize}
