...
The A\(\Omega\) field-map table lists the manual mapping from measured-sector names to A\(\Omega\) field supports. Field-support properties are listed in the main note, App.~J.
...
\subsection{Measured rest-energy target records}\label{manual:rest:measured-comparison-analysis}
