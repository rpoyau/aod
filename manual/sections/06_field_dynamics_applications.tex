...
\midrule
\endhead
Density & \(\epsilon_\rho\) & \(\rho(R,z,\theta,t)\) or radial proxy & 3D / 2D / radial / proxy / unresolved\\
Velocity & \(\epsilon_v\) & \(v(R,z,\theta,t)\) or radial speed & vector / radial / proxy / unresolved\\
...
Sheddic route & \(\epsilon_X\) & \(\operatorname{SheddicPath}\) & declared / inferred / unresolved\\
External map & \(\epsilon_K\) & \(K_{\mathrm{ext}}\) or \(\lambda\) & frozen / calibrated / undeclared\\
\bottomrule
\end{longtable}
...
Sheddic route & \(\epsilon_X\) & \(\sigma_X\) & route / slosh / pending\\
