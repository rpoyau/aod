...
Omitted context & galaxy-internal contexts outside the reported shell row \\
First refinement & galaxy-specific full rotation ledger \\
...
\bottomrule
\end{tabularx}
\ManualTableNote{The SPARC report map must be explicit before the calculated column is complete.}
\end{threeparttable}
\end{table}
