...
\section{Exact Internal Fixtures}
\label{manual:cross-return-short-window}
...
\subsection{Dimonhexon cross-return fixture}
\label{manual:cross-return:dimonhexon-slit}
...
\subsection{Recurrent-ring double-slit cross-return}
\label{manual:cross-return:ring-double-slit}
...
\subsubsection{Exact double-slit fixture}
\label{manual:cross-return:exact-double-slit-fixture}
...
\subsection{Short-window fixture scope}
\label{manual:short-window:scope}
...
\subsection{Shared fixture equations}
\label{manual:short-window:equations}
...
\subsection{Closure-dependent and surplus fixtures}
\label{manual:short-window:fixture-table}
...
\subsection{The \texorpdfstring{\(1{:}2{:}7\)}{1:2:7} closure-dependent fixture}
\label{manual:short-window:127}
...
\subsection{The \texorpdfstring{\(1{:}2{:}9\)}{1:2:9} surplus fixture}
\label{manual:short-window:129}
...
\subsection{The \texorpdfstring{\(1{:}2{:}10\)}{1:2:10} clipped retained fixture}
\label{manual:short-window:1210}
...
\subsection{Sheddic path audit}
\label{manual:short-window:shedpath-audit}
...
\label{manual:short-window:audit-hooks}
...
\paragraph{Duration-domain declaration.}
These reductions declare \(R^{\mathrm{asym}}=\mathrm{id}\) and the additive native
count realization, so \(\rho^D=RD\) in this specialization. The window is a
count in that same domain; \(\rho^D_\omega=\min(\rho^D,|\omega|)\) is scalar
participation. Neither support RD nor the coupled RCD object is clipped.
