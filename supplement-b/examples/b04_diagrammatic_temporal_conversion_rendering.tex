...
\paragraph{Diagrammatic rendering.} The collision/export rows may also be rendered in a diagrammatic dictionary view after the cited row has been fixed. The rendering below is a later compression of the same integer ledgers recorded for Example~E6 in the native supplement.
