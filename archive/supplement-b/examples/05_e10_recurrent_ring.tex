...
\paragraph{Loss-channel convention.} The primitive loss-facing channel is reported here as $R_{\mathrm{loss}}$ [trit/bip], with the same value as the cited loss channel on the cited row.
