...
\end{tabular}
\end{center}}
\paragraph{Jensen discipline.} Histogram weighting and attenuation must be formed on the cited sample set before any averaging. If $T_{\mathrm{eval}}=n_1+n_2+n_3$ and $\bar m=(n_1+2n_2+3n_3)/T_{\mathrm{eval}}$, then the exact loss-average is
\[
